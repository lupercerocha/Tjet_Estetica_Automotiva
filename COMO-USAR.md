...
A partir da v3.5.0 o sistema é à prova de dependência externa. Antes, se a
...
Na tela inicial, ao lado da data, tem um selo pequeno: **v3.5.0**. É a forma mais
...
## Custos fixos e ponto de equilíbrio (v3.5.0)
